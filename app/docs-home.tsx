      ...
      <div id="top" className="layout">
        ...
        <main className="content">
          <section className="hero" id="overview">
            <p className="eyebrow">Документация Guard</p>
            <h1>Документация TechCatalyst Guard</h1>
            <p>
              Руководства для пользователей, администраторов, инженеров эксплуатации и разработчиков. Здесь описаны
              рабочие станции, агенты, политики безопасности, события, интеграции и эксплуатация Guard.
            </p>
